...
An Interim Report called ‘Complexity, Challenges and Opportunities for Carbon Neutral Digital Research’ has been published by the UKRI Net Zero DRI Scoping Project team. The report summarises the key recommendations (backed by evidence) for reaching the UKRI’s net zero targets by 2040 for digital research infrastructure (DRI). The findings have been collected from an extensive literature survey and will form the technical foundations of the Final Report, which is due for completion in June 2023.  
